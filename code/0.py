...
def plt_active():
	active_ne = np.array([4898.80,3234.60,3159.30,2902.60,2762.40,2883.50,2874.00,3395.00,3176.60,2702.10,2374.20,2469.80])
...
def plt_use():
	ret_ne = np.array([15.8,21.1,19.3,17.1,16.2,16.1,15.8,16.8,17,16.9,16.8,17.1])
